...
namespace SharedDriveConnection
{
    ...
    /// </summary>
    public class DriveConnect : IDisposable
    {
        #region Variables
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DriveConnect"/> class.
        /// </summary>
        ...
        /// </param>
        public DriveConnect(string networkName, NetworkCredential credentials)
        {
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="DriveConnect"/> class.
